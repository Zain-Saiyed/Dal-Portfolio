                      ...
                      <Box style={{textAlign: 'justify'}}>
                        <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: "1rem" }}>
                          <a key={index} href={`/portfolio/${user_name}/project/${project.project_id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                            <Typography style={{ fontSize: "1.5rem", fontWeight: 'bold', color: '#0d47a1', textAlign: onMobile ? "left" : "justify" }}>{project.title} <Icon name="newtab" style={{ verticalAlign: "middle", marginRight: "5px", color:'black'}} /></Typography>
                          </a>
                        ...
                        <Box>
                          <Button variant="contained" href={project.github_link} startIcon={<Icon name="github" />}>
                            View on GitHub
                          </Button>
                          {onMobile ? (
                            <>
                              <br />
                              <Button variant="contained" href={project.demo_link} startIcon={<Icon name="link" />} style={{marginTop: "1rem", background: "purple", color: "white"}}> 
                                View demo 
                              </Button>
                            </>
                          ) : (
                            <Button variant="contained" href={project.demo_link} startIcon={<Icon name="link" />} style={{marginLeft: "1rem", background: "purple", color: "white"}}> 
                              View demo 
                            </Button>
                          )}
                        </Box>
