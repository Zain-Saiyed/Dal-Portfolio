  ...
  return ( 
    <section id={id} style={{ minHeight: "100vh", padding: "3rem" }}> 
      <Box sx={{ p: onMobile ? "100px 0" : "160px 0px 0px 0px" }}>
        <Box sx={{ my: "auto" }}>
          <Box
            sx={{ mb: "2rem", flex: 1, flexBasis: "50%", justifyContent: "center",
                ...
                <Paper key={index} elevation={3} style={{ marginBottom: '20px', breakInside: 'avoid' }}> {/* , backgroundColor: index % 2 === 0 ? '#F0F2EF' : '#fff' */}
                  <div style={{ display: 'flex', alignItems: 'center', padding: '20px' }}>
                    ...
                    <div>
                      ...
                      <Typography >Issued Date: {new Date(certification.issue_date).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</Typography>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', marginTop: '1rem' }}>
                        ...
                        <Icon name="verified" sx={{ marginLeft: '10px', color: 'green' }} />
                      </div>
                    </div>
                  </div>
                </Paper>
