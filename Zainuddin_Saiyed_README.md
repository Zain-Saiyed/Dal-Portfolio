...
* *Assignment (Project Feature) URL*: https://main--csci-5709-group-1-dal-portfolio.netlify.app/portfolios/660ba6e509278cf966dcfb0d
...
## Feature and its related tasks developed by Sushank Saini
### Feature: 
* Portfolio Template
### Related Tasks:
...
## List of files authored by Zainuddin Saiyed
### Frontend
* frontend\src\pages\Portfolio\index.tsx
* frontend\src\pages\Portfolio\Sections\Bio.tsx
* frontend\src\pages\Portfolio\Sections\Certifications.tsx
* frontend\src\pages\Portfolio\Sections\Contact.tsx
* frontend\src\pages\Portfolio\Sections\Education.tsx
* frontend\src\pages\Portfolio\Sections\Projects.tsx
* frontend\src\pages\Portfolio\Sections\Resume.tsx
* frontend\src\pages\Portfolio\Sections\Skills.tsx
* frontend\src\pages\Portfolio\Sections\WorkExperience.tsx
* frontend\src\pages\Portfolio\Project.tsx
* frontend\src\hooks\textColor.ts

### Backend
* backend\src\api\controllers\portfolio\index.js
* backend\src\api\controllers\portfolio\portfolio\portfolio.js
* backend\src\api\controllers\portfolio\portfolio\project.js
* backend\src\api\routes\portfolio.js
...
* The webpage structural elements, font, spacing (padding, margins, etc), Sections, etc are inspired from Dalhousie University branding style to ensure a minimalistic layout with a simple and professional font.
